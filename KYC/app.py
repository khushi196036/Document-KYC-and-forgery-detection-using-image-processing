# import sys
# sys.path.append(r'C:\Users\rahul shinde\AppData\Local\Programs\Python\Python312\Lib\site-packages')
...
app = Flask(__name__)
app.secret_key = "abc"
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:Shru7%40123@localhost:3306/kyc'
db = SQLAlchemy(app)
            ...
            if 'file' in request.files:
                ...
                if uploaded_file.filename != '':
                    ...
                    if 'user_id' in session:
                        ...
                        existing_details = Details.query.filter_by(aadhar_number=extracted_data.get('aadhaar_number')).first()
                        if existing_details:
                            # Update the existing record with new data
                            existing_details.id = user_id
                            existing_details.name = extracted_data.get('name')
                            existing_details.dob = extracted_data.get('dob')
                            existing_details.gender = extracted_data.get('gender')
                            existing_details.image_path = extracted_data.get('image_path')
                        else:
                        ...
                        try:
                            ...
                            msg = "Data already exists"  # Customize the message as needed
                        ...
                        if user_details:
                            ...
                            # Handle the case where user_details is None
                    ...
                    if user:
                        ...
                        return render_template("hello.html", user=user, popup_msg=msg)
